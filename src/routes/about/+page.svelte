...
<div class="card p-4 m-4 flex-wrap">
	...
	<div class="px-6 py-2">
		...
		<a href="https://github.com/GibreelAbdullah/Hadith-Hub"> here </a> and all the data in the app
		can be found
		<a href="https://github.com/GibreelAbdullah/hadith-api"> here</a>. We will be grateful if you
		contribute in this project to make it better.
	</div>
	<div class="px-6 py-2">
		An <a href="https://play.google.com/store/apps/details?id=com.islamicproapps.hadithpro"
			>Android App</a
		>
		using the same data as HadithHub.com is also available. It was made by
		<a href="https://github.com/unkn4wn">unkn4wn</a> and the source code can be found
		<a href="https://github.com/unkn4wn/hadith-pro">here</a>. May Allah reward him.
	</div>
	<div class="px-6 py-2">
		It would be a grave injustice to omit the mention of
		<a href="https://github.com/fawazahmed0"> Fawaz Ahmed </a> who made the enormous effort in collecting
	...
	<div class="px-6 py-2">
		<a href="https://github.com/fawazahmed0" class="font-bold"> Fawaz Ahmed </a> : For collecting
		all the
		<a href="https://github.com/fawazahmed0/hadith-api">Ahadith data</a>. A complete list of sources
		of the data can be found
		<a href="https://github.com/fawazahmed0/hadith-api/blob/1/References.md">here</a>.
	</div>
	<div class="px-6 py-2">
		<a href="https://sunnah.com" class="font-bold"> Sunnah.com </a> : For providing us with their Ahadith
		database.
	</div>
	<div class="px-6 py-2">
		<a href="https://github.com/GibreelAbdullah/HadithHub/graphs/contributors" class="font-bold">
			Contributors - UI</a
		> : Contributors who helped in creating the website.
	</div>
	<div class="px-6 py-2">
		<a href="https://github.com/GibreelAbdullah/hadith-api/graphs/contributors" class="font-bold">
			Contributors - Data</a
		> : Contributors who helped in collecting hadith/gradings or correcting them.
	</div>
	<div class="px-6 py-2">
		<a href="https://svelte.dev/" class="font-bold"> Svelte</a> : A front-end, open-source JavaScript
		framework for making interactive webpages.
	</div>
	<div class="px-6 py-2">
		<a href="https://www.skeleton.dev/" class="font-bold"> Skeleton</a> : A fully featured UI Toolkit
		for svelte.
	</div>
	<div class="px-6 py-2">
		<a href="https://github.com/bubkoo/html-to-image/" class="font-bold"> html-to-image </a> : A javascript
