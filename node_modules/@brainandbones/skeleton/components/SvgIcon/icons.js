...
export let icons = {
    ...
    // ----------- Brand Logos -----------
    // Github
    // Source: https://fontawesome.com/icons/github?s=brands
    github: {
    ...
    // Discord
    // Source: https://fontawesome.com/icons/discord?s=brands
    discord: {
        viewBox: '0 0 640 512',
    ...
    // Twitter
    // Source: https://fontawesome.com/icons/twitter?s=brands
    twitter: {
    ...
    // NPM
    // Source: https://fontawesome.com/icons/npm?s=&f=brands
    npm: {
        viewBox: `0 0 576 512`,
    ...
    // ----------- Components -----------
    // Accordian
    // Source: https://fontawesome.com/icons/angle-down?s=solid
    'angle-down': {
        viewBox: `0 0 384 512`,
    ...
    // Lightswitch
    // Source: https://fontawesome.com/icons/sun?s=solid
    sun: {
    ...
    // Source: https://fontawesome.com/icons/moon?s=solid
    moon: {
    ...
    // ----------- Documentation -----------
    // Source: https://fontawesome.com/icons/bars?s=solid
    bars: {
        viewBox: '0 0 576 512',
    ...
    // Source: https://fontawesome.com/icons/house?s=solid
    house: {
        viewBox: '0 0 576 512',
    ...
    // Source: https://fontawesome.com/icons/circle-question?s=solid
    'circle-question': {
    ...
    // Source: https://fontawesome.com/icons/circle-check?s=solid
    'circle-check': {
    ...
    // Source: https://fontawesome.com/icons/heart?s=solid
    heart: {
    ...
    // Source: https://fontawesome.com/icons/skull?s=solid
    skull: {
    ...
    // Source: https://fontawesome.com/icons/align-left?s=solid
    'align-left': {
        viewBox: '0 0 448 512',
    ...
    // Source: https://fontawesome.com/icons/align-justify?s=solid
    'align-justify': {
        viewBox: '0 0 448 512',
    ...
    // Source: https://fontawesome.com/icons/align-right?s=solid
    'align-right': {
        viewBox: '0 0 448 512',
    ...
    // https://fontawesome.com/icons/clapperboard?s=solid
    clapperboard: {
    ...
    // https://fontawesome.com/icons/tv?s=solid
    tv: {
        viewBox: '0 0 640 512',
    ...
    // Source: https://fontawesome.com/icons/swatchbook?s=solid
    swatchbook: {
    ...
    // Source: https://fontawesome.com/icons/screwdriver-wrench?s=solid
    screwdriver: {
    ...
    // Source: https://fontawesome.com/icons/copy?s=solid&f=classic
    copy: {
        viewBox: '0 0 512 512',
        path: 'M224 0c-35.3 0-64 28.7-64 64V288c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64H224zM64 160c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64H288c35.3 0 64-28.7 64-64V384H288v64H64V224h64V160H64z'
    },
    // Source: https://fontawesome.com/icons/cubes?s=solid&f=classic
    cubes: {
        viewBox: '0 0 576 512',
